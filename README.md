...
- [Suede AI](https://suedeai.ai) — x402-payable creative media generation API on Base, with music ($0.50), video ($4.99), and image ($0.15) endpoints advertised through public discovery. ([x402 discovery](https://app.suedeai.ai/.well-known/x402.json), [OpenAPI](https://app.suedeai.ai/openapi.json), [endpoint reference](https://github.com/Suede-AI/suede-x402-acp))
